...
def load_nafbl():
    ...
    # load_standings_standard('us_minor', 'minor/nafbl', root=US_MINOR_DIR)
    # load_standings_standard('us_minor', 'minor/snesl', root=US_MINOR_DIR)
    # load_standings_standard('us_minor', 'minor/nasfl', root=US_MINOR_DIR)
...
def load_modern_friendly():
    ...
    load_games_standard('us_friendly', 'games/friendly/1960', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/1967', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/1970', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/1980', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/tours/1970', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/tours/1980', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/1990', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/2000', root=FRIENDLY_DIR)
    load_games_standard('us_friendly', 'games/friendly/2010', root=FRIENDLY_DIR)

    # All-Star game.
    load_games_standard('us_friendly', 'games/friendly/mls_all_star', root=FRIENDLY_DIR)
